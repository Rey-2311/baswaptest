...
if page == "Overview":
    ...
    display_view(filtered_df, target_col, f"{texts['raw_view']} {target_col}", resample_freq="None", selected_cols=col_names, agg_functions=agg_functions)
    display_view(filtered_df, target_col, f"{texts['hourly_view']} {target_col}", resample_freq="Hour", selected_cols=col_names, agg_functions=agg_functions)
    display_view(filtered_df, target_col, f"{texts['daily_view']} {target_col}", resample_freq="Day", selected_cols=col_names, agg_functions=agg_functions)
